    ...
    <div class="card-body">
        <form>
            ...
            <div class="form-group">
                ...
                <input type="text" id="autoSuspend" class="form-control" placeholder="<?php get_site_option( 'wpcp_auto_suspend', '3' , false ) ?>"" required>
            ...
            <div class="form-group">
                ...
                <input type="text" id="autoTerminate" class="form-control" placeholder="<?php get_site_option( 'wpcp_terminate', '10' , false ) ?>"" required>
