    ...
    <div class="card-body">
        <form>
            <div class="form-group">
                ...
                <input type="text" id="invoice" class="form-control" placeholder="<?php get_option( 'wpcp_invoice', '14' , false ) ?>" required>
            ...
            <div class="form-group">
                ...
                <input type="text" id="autoSuspend" class="form-control" placeholder="<?php get_option( 'wpcp_auto_suspend', '3' , false ) ?>"" required>
            ...
            <div class="form-group">
                ...
                <input type="text" id="autoTerminate" class="form-control" placeholder="<?php get_option( 'wpcp_terminate', '10' , false ) ?>"" required>
