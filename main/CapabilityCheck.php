...
class CapabilityCheck
{
    ...
    function checkCapability(){
        ...
        if($this->function == 'fetchTemplateContent' || $this->function == 'cyberpanel_main_emails_html' || $this->function == 'saveSettings' || $this->function == 'jobStatus' || $this->function == 'cyberpanel_provider_html'
